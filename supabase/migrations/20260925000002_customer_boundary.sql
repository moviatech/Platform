...
drop policy if exists reservation_line_items_customer_read on public.reservation_line_items;
drop policy if exists payments_customer_read on public.payments;
drop policy if exists agreements_customer_read on public.agreements;
drop policy if exists vehicles_customer_read on public.vehicles;
drop policy if exists inspections_customer_read on public.inspections;
drop policy if exists conversations_customer_read on public.conversations;
drop policy if exists messages_customer_read on public.messages;
drop policy if exists change_requests_customer_read on public.change_requests;
drop policy if exists message_attachments_customer_read on public.message_attachments;
drop policy if exists ratings_customer_read on public.ratings;
